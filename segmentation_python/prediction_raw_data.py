...
def predict(dataset, batch_size, num_epochs, save_prediction_interval = 1, load_from_chkpt=None):
    '''
...
if __name__ == '__main__':
    ...
    predict(dataset=dataset,batch_size=batch_size,num_epochs=num_epochs, load_from_chkpt = chkpt)
